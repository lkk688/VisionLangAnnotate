...
RESULT_END"""
    ...
    def describe_image(self, image_path: str, prompt: str = None) -> str:
        """
        Generate a description of the image using the VLM model.
        
        Args:
            image_path (str): Path to the image file
            prompt (str, optional): Custom prompt for image description. If None, uses default prompt.
        ...
        try:
            ...
            # Use provided prompt or default description prompt
            if prompt is None:
                description_prompt = (
                    "Please provide a detailed description of this image. "
                    "Describe what you see, including objects, people, scenery, colors, "
                    "and any notable details or activities taking place."
                )
            else:
